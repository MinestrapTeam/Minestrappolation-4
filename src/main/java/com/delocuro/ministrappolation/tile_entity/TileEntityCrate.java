...
public class TileEntityCrate extends TileEntityChest{
    ...
    private void func_174910_a(TileEntityChest p_174910_1_, EnumFacing p_174910_2_)
    {
        ...
        {
            switch (TileEntityCrate.SwitchEnumFacing.field_177366_a[p_174910_2_.ordinal()])
            {
                case 1:
    ...
    {
        return "ministrappolation:crate";
    }
	...
	public void update()
    {
        ...
        if (!this.worldObj.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + i + j + k) % 200 == 0)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    IInventory iinventory = ((ContainerCrate)entityplayer.openContainer).getLowerChestInventory();
