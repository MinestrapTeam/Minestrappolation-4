...
import minestrapteam.minestrappolation.item.ItemBlockBiomeCopper;
import minestrapteam.minestrappolation.item.ItemBlockBiomeDiamond;
import minestrapteam.minestrappolation.item.ItemBlockBiomeEmerald;
...
import minestrapteam.minestrappolation.item.ItemBlockBiomeMeurodite;
import minestrapteam.minestrappolation.item.ItemBlockBiomePlutonium;
import minestrapteam.minestrappolation.item.ItemBlockBiomeRadiant;
...
import minestrapteam.minestrappolation.item.ItemBlockBiomeSunstone;
import minestrapteam.minestrappolation.item.ItemBlockBiomeTin;
import minestrapteam.minestrappolation.item.ItemBlockBiomeTitanium;
import minestrapteam.minestrappolation.item.ItemBlockBiomeTorite;
import minestrapteam.minestrappolation.item.ItemBlockBiomeUranium;
