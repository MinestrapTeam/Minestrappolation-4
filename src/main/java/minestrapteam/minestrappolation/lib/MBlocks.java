...
import minestrapteam.minestrappolation.block.BlockMMelon;
...
import minestrapteam.minestrappolation.block.machines.BlockBarrel;
import minestrapteam.minestrappolation.block.machines.BlockCrate;
import minestrapteam.minestrappolation.block.machines.BlockCrusher;
import minestrapteam.minestrappolation.block.machines.BlockFrostGenerator;
...
import minestrapteam.minestrappolation.block.machines.BlockStoneCutter;
...
import minestrapteam.minestrappolation.item.blocks.ItemBlockBiomeBricks;
import minestrapteam.minestrappolation.item.blocks.ItemBlockChiseled;
import minestrapteam.minestrappolation.item.blocks.ItemBlockColdSand;
import minestrapteam.minestrappolation.item.blocks.ItemBlockCrackedBricks;
import minestrapteam.minestrappolation.item.blocks.ItemBlockLampGlowstone;
import minestrapteam.minestrappolation.item.blocks.ItemBlockLampPrismarine;
import minestrapteam.minestrappolation.item.blocks.ItemBlockLampSunstone;
import minestrapteam.minestrappolation.item.blocks.ItemBlockLeaves;
import minestrapteam.minestrappolation.item.blocks.ItemBlockLog;
import minestrapteam.minestrappolation.item.blocks.ItemBlockMSlab;
import minestrapteam.minestrappolation.item.blocks.ItemBlockMossyBricks;
import minestrapteam.minestrappolation.item.blocks.ItemBlockMossyCobble;
import minestrapteam.minestrappolation.item.blocks.ItemBlockPatternBricks;
import minestrapteam.minestrappolation.item.blocks.ItemBlockPermaFrost;
import minestrapteam.minestrappolation.item.blocks.ItemBlockPlanks;
import minestrapteam.minestrappolation.item.blocks.ItemBlockRefined;
import minestrapteam.minestrappolation.item.blocks.ItemBlockRoads;
import minestrapteam.minestrappolation.item.blocks.ItemBlockSapling;
import minestrapteam.minestrappolation.item.blocks.ItemBlockTiles;
...
public class MBlocks
{
	...
	public static void init()
	{
		...
		soul_ore = new BlockSoulOre(Material.ground, MapColor.stoneColor, MItems.soul_gem, 0, 1, 7, 1, 0, "shovel", 2, true).setHardness(2.0F).setStepSound(Block.soundTypePiston).setResistance(3.0F).setUnlocalizedName("soul_ore").setCreativeTab(Minestrappolation.tabMBuilding);
