...
public class BlockBiomeSunstone extends MBlockOre
{
	...
	public static void preinventoryRender()
	{
		...
		ModelBakery.addVariantName(itemBlockBrickVariants, "ministrapp:glacierrock_sunstone");
		ModelBakery.addVariantName(itemBlockBrickVariants, "ministrapp:deep_coldstone_sunstone");
		ModelBakery.addVariantName(itemBlockBrickVariants, "ministrapp:red_rock_sunstone");
