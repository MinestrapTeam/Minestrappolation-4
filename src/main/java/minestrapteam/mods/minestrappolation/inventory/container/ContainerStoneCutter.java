...
public class ContainerStoneCutter extends Container
{
	...
	public ContainerStoneCutter(EntityPlayer player, TileEntityStoneCutter te)
	{
		...
		this.addSlotToContainer(
			new SlotStoneCutter(player, this.craftMatrix, this.craftResult, this.extraSlot, 0, 124 + 14, 35));
	...
	{
		this.craftResult.setInventorySlotContents(0, StonecuttingManager.instance().findMatchingRecipe(this.craftMatrix,
		                                                                                               this.extraSlot
			                                                                                               .getStackInSlot(
				                                                                                               0), this.stoneCutter
			                                                                                               .getWorld()));
	...
	public void onContainerClosed(EntityPlayer player)
	{
		...
		if (!this.stoneCutter.getWorld().isRemote)
		{
			...
			ItemStack extraItem = this.extraSlot.removeStackFromSlot(0);
			if (extraItem != null)
			{
	...
	public boolean isItemAddon(ItemStack itemStack)
	{
		...
		return item instanceof ItemDye ||
