...
{
	public static final ResourceLocation texture = new ResourceLocation(MReference.MODID,
	                                                                    "textures/gui/enderporter.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		if (this.porter.getChipBlock() != MBlocks.enderporter && !this.porter.hasSelfSufficient())
		{
		...
		else
		{
			this.fontRendererObj.drawString(
				this.porter.getChipPos().getX() + ", " + this.porter.getChipPos().getY() + ", " + this.porter.getChipPos().getZ(), 7,
				40, 4210752);
		}
