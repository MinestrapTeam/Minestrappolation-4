...
public class BlockFlesh extends MBlock
{
	...
	{
		float f = 0.0625F;
		return new AxisAlignedBB(pos.getX() + f, pos.getY(), pos.getZ() + f, pos.getX() + 1 - f,
		                         pos.getY() + 1 - (2 * f), pos.getZ() + 1 - f);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		if ((playerIn.getCurrentEquippedItem() != null)
			    && playerIn.getCurrentEquippedItem().getItem() == Items.potionitem && (playerIn.getCurrentEquippedItem()
			                                                                                   .getItemDamage() == 8193
				                                                                           || playerIn
