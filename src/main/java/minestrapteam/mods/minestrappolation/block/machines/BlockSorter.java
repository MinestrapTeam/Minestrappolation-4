...
public class BlockSorter extends BlockContainer
{
	...
	public BlockSorter(Material materialIn, MapColor mapColorIn)
	{
	...
	{
		int dir = worldIn.getBlockState(pos).getValue(FACING).getIndex();
		if (dir == 1)
		{
			...
			for (int i1 = 0; i1 < inventory.getSizeInventory(); ++i1)
			{
				...
				if (itemstack != null)
				{
					...
					for (float f2 = world.rand.nextFloat() * 0.8F + 0.1F;
					     itemstack.stackSize > 0; world.spawnEntityInWorld(entityitem))
					{
						...
						entityitem = new EntityItem(world, pos.getX() + f, pos.getY() + f1, pos.getZ() + f2,
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		playerIn
			.openGui(Minestrappolation.instance, MGuiHandler.GUIID_PIPE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
