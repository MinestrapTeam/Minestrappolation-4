...
public class BlockPatternBricks extends MBlock{
	...
	public static void inventoryRender()
	{
		...
		ModelBakery.addVariantName(itemBlockBrickVariants, "ministrapp:glacierrock_pattern_bricks");
		ModelBakery.addVariantName(itemBlockBrickVariants, "ministrapp:deep_coldstone_pattern_bricks");
		ModelBakery.addVariantName(itemBlockBrickVariants, "ministrapp:red_rock_pattern_bricks");
