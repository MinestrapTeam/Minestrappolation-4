...
public class MDictionary
{
	...
	public static void load()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(MBlocks.enderporter, 2), new Object[] { "JAJ", "OEO", "DCD", 'J', MBlocks.jadachite_block, 'A', MItems.advanced_tech_doodad, 'O', MBlocks.obsidian_bricks, 'E', MItems.ender_aura, 'D', "ingotDimensium", 'C', MItems.crystal_heart }));
