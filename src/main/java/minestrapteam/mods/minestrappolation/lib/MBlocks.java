...
public class MBlocks
{
	...
	{
		//Soil Blocks
		cold_sand = new BlockMSand(SoundType.SAND).setUnlocalizedName("cold_sand").setHardness(0.7F).setCreativeTab(Minestrappolation.tabMBuilding);
		lichen_permafrost = new BlockPermaFrost(SoundType.PLANT).setUnlocalizedName("permafrost").setHardness(1F).setCreativeTab(Minestrappolation.tabMBuilding);
		dirt_permafrost = new BlockPermaFrostDirt(Material.GROUND, MapColor.CLAY, SoundType.GROUND).setHardness(0.9F).setUnlocalizedName("dirt_permafrost").setCreativeTab(Minestrappolation.tabMBuilding);
		mud = new BlockMud(Material.GROUND, MapColor.BROWN, SoundType.SLIME).setHardness(0.5F).setUnlocalizedName("mud").setCreativeTab(Minestrappolation.tabMBuilding);
		rubble = new BlockMFalling(Material.ROCK, MapColor.STONE, SoundType.STONE).setHardness(0.7F).setUnlocalizedName("rubble").setCreativeTab(Minestrappolation.tabMBuilding);
		wither_ash = new BlockWitherAsh(SoundType.SAND).setHardness(0.1F).setUnlocalizedName("wither_ash").setCreativeTab(Minestrappolation.tabMMaterials);
		virtian_soil = new BlockVirtianSoil(SoundType.GROUND).setHardness(0.6F).setCreativeTab(Minestrappolation.tabMBuilding).setUnlocalizedName("virtian_soil");
		virtian_grass = new BlockVirtianGrass(SoundType.PLANT).setHardness(0.6F).setCreativeTab(Minestrappolation.tabMBuilding).setUnlocalizedName("virtian_grass");
		
		//Plants
		ministrapp_leaves = new MBlockLeaves(600).setUnlocalizedName("ministrapp_leaves");
		ministrapp_sapling = new MBlockSapling(600);
		dead_branch = new BlockDeadBranch(Material.VINE, MapColor.WOOD, SoundType.PLANT).setCreativeTab(Minestrappolation.tabMDecor).setUnlocalizedName("dead_branch");
		shrub_grass = new BlockShrubGrass(SoundType.PLANT).setCreativeTab(Minestrappolation.tabMDecor).setUnlocalizedName("shrub_grass");
		moss = new BlockMoss(MapColor.GREEN, SoundType.CLOTH).setHardness(0.3F).setUnlocalizedName("moss").setCreativeTab(Minestrappolation.tabMDecor);
		hanging_moss = new BlockHangingMoss(600, SoundType.PLANT).setUnlocalizedName("hanging_moss").setCreativeTab(Minestrappolation.tabMDecor);
		hanging_glow_moss = new BlockHangingMoss(0, SoundType.PLANT).setLightLevel(0.8F).setUnlocalizedName("hanging_glow_moss").setCreativeTab(Minestrappolation.tabMDecor);
		blueberry_bush = new BlockBush(Material.LEAVES, MItems.blueberry, MapColor.GREEN, SoundType.PLANT).setCreativeTab(Minestrappolation.tabMDecor).setUnlocalizedName("blueberry_bush");
		blackberry_bush = new BlockBush(Material.LEAVES, MItems.blackberry, MapColor.GREEN, SoundType.PLANT).setCreativeTab(Minestrappolation.tabMDecor).setUnlocalizedName("blackberry_bush");
		raspberry_bush = new BlockBush(Material.LEAVES, MItems.raspberry, MapColor.GREEN, SoundType.PLANT).setCreativeTab(Minestrappolation.tabMDecor).setUnlocalizedName("raspberry_bush");
		strawberry_bush = new BlockBush(Material.LEAVES, MItems.strawberry, MapColor.GREEN, SoundType.PLANT).setCreativeTab(Minestrappolation.tabMDecor).setUnlocalizedName("strawberry_bush");
		mana_bush = new BlockBush(Material.LEAVES, MItems.mana_leaf, MapColor.LIGHT_BLUE, SoundType.PLANT).setCreativeTab(Minestrappolation.tabMDecor).setUnlocalizedName("mana_bush");
		seaweed = new BlockSeaweed(SoundType.PLANT).setUnlocalizedName("seaweed").setCreativeTab(Minestrappolation.tabMDecor);
		...
		onion = new ItemSeedFood(2, 0.2F, onion_crop, Blocks.FARMLAND).setPotionEffect(new PotionEffect(MobEffects.BLINDNESS, 10, 0), 0.1F).setUnlocalizedName("onion").setCreativeTab(Minestrappolation.tabMFood);
		...
		jadachiteroot = new BlockJadachiteRoot(Material.glass, MapColor.greenColor).setLightLevel(1.0F).setUnlocalizedName("jadachiteroot").setCreativeTab(Minestrappolation.tabMDecor);
