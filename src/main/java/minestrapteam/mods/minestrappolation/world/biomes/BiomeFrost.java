...
public class BiomeFrost extends Biome
{
	public BiomeFrost(Biome.BiomeProperties properties)
	{
		super(properties);
	...
	{
		return random.nextInt(4) == 0 ? BiomeForest.BIG_TREE_FEATURE : new WorldGenFrostTree();
	}
