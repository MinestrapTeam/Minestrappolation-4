...
public class ClientProxy extends CommonProxy
{
	...
	public void registerRenders()
	{
		...
		//TODO Updated in 1.10 is this new way of registering entitites.
		RenderingRegistry.registerEntityRenderingHandler(EntityMudBall.class, new IRenderFactory<EntityMudBall>() 
		{
			@Override
			public Render<? super EntityMudBall> createRenderFor(RenderManager manager) 
			{
				return new RenderMudBall(Minecraft.getMinecraft().getRenderManager(), MItems.mud_ball, Minecraft.getMinecraft().getRenderItem());
			}
		});
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityIceball.class, new IRenderFactory<EntityIceball>() 
		{
			...
			{
				return new RenderIceBall(Minecraft.getMinecraft().getRenderManager(), MItems.ice_charge, Minecraft.getMinecraft().getRenderItem());
			}
		});
