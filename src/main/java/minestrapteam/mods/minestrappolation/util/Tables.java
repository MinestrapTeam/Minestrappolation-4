...
public class Tables {
	...
	private static void populateTables()
	{
    	...
    	Chance.addToChanceTable("overworld_items", new ItemStack(Blocks.sandstone, 16, 1), 10);
    	...
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_redstone, 3, 0), 7);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_redstone, 3, 2), 7);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_redstone, 3, 4), 7);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_redstone, 3, 6), 7);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_redstone, 3, 8), 7);
    	Chance.addToChanceTable("overworld_items", new ItemStack(Blocks.coal_ore, 6, 0), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 0), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 1), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 2), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 3), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 4), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 5), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 6), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 7), 6);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_coal, 6, 8), 6);
    	...
    	Chance.addToChanceTable("overworld_items", new ItemStack(Blocks.iron_ore, 5, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.copper_ore, 5, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 1), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 2), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 3), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 4), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 5), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 6), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 7), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_copper, 5, 8), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.tin_ore, 5, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 1), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 2), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 3), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 4), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 5), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 6), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 7), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_tin, 5, 8), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 1), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 2), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 3), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 4), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 5), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 6), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 7), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_iron, 5, 8), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_gold, 2, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_gold, 2, 2), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_gold, 2, 4), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_gold, 2, 6), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_gold, 2, 8), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_meurodite, 2, 0), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_meurodite, 2, 2), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_meurodite, 2, 4), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_meurodite, 2, 6), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_meurodite, 2, 8), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_emerald, 1, 3), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_emerald, 1, 4), 5);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_lapis, 2, 0), 4);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_lapis, 2, 2), 4);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_lapis, 2, 4), 4);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_lapis, 2, 6), 4);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_lapis, 2, 8), 4);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_torite, 1, 0), 3);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_torite, 1, 2), 3);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_torite, 1, 4), 3);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_torite, 1, 6), 3);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_torite, 1, 8), 3);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.sunstone_ore, 2, 0), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 0), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 1), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 2), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 3), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 4), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 5), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 6), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 7), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_sunstone, 2, 8), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_plutonium, 1, 0), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_plutonium, 1, 2), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_plutonium, 1, 4), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_plutonium, 1, 6), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_plutonium, 1, 8), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_uranium, 1, 0), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_uranium, 1, 2), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_uranium, 1, 4), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_uranium, 1, 6), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_uranium, 1, 8), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_diamond, 1, 0), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_diamond, 1, 2), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_diamond, 1, 4), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_diamond, 1, 6), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_diamond, 1, 8), 2);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.radiant_ore, 1, 0), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 0), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 1), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 2), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 3), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 4), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 5), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 6), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 7), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_radiant, 1, 8), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_titanium, 1, 0), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_titanium, 1, 2), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_titanium, 1, 4), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_titanium, 1, 6), 1);
    	Chance.addToChanceTable("overworld_items", new ItemStack(MBlocks.biome_titanium, 1, 8), 1);
