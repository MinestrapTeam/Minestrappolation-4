...
public class Tables {
	...
	private static void populateTables()
	{
    	...
    	Chance.addToChanceTable("sifter_clay", new ItemStack(Items.SKULL, 1, 0), 10);
    	...
    	Chance.addToChanceTable("sifter_virtian_soil", new ItemStack(Item.getItemFromBlock(MBlocks.purple_glowshroom), 1), 8);
    	Chance.addToChanceTable("sifter_virtian_soil", new ItemStack(Item.getItemFromBlock(MBlocks.green_glowshroom), 1), 8);
