...
public class TileEntitySorter extends TileEntityLockable implements IHopper, ITickable, ISidedInventory
{
    ...
    private boolean transferItemsOut()
    {
    	...
    	{
    		if(this.getStackInSlot(0).getItem() == this.getStackInSlot(1).getItem() && this.getStackInSlot(0).getMetadata() == this.getStackInSlot(1).getMetadata())
    		{
        ...
        else
        {
            ...
            else
            {
                if (this.getStackInSlot(0) != null)
                {
                    ...
                    ItemStack itemstack1 = putStackInInventoryAllSlots(iinventory, this.decrStackSize(0, 1), enumfacing);
    ...
    {    
         ...
         */
        return getInventoryAtPosition(this.getWorld(), (double)(this.pos.getX() + facing.getFrontOffsetX()), (double)(this.pos.getY() + facing.getFrontOffsetY()), (double)(this.pos.getZ() + facing.getFrontOffsetZ()));
    }
