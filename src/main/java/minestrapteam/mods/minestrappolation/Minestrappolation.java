...
public class Minestrappolation
{
	...
	public void init(FMLInitializationEvent event)
	{
		...
		proxy.init(event);
		MGenHandler.load();
		EntityRegistry.registerModEntity(RenderMudBall.texture, EntityMudBall.class, "mud_ball", 0, Minestrappolation.instance, 350, 5, true); //TODO Possible id error?
		EntityRegistry.registerModEntity(RenderIceBall.texture, EntityIceball.class, "ice_ball", 0, Minestrappolation.instance, 350, 5, true);
