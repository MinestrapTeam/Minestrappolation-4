...
public class MGuiHandler implements IGuiHandler
{
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		{
			return new ContainerBackpack(player, player.inventory, new InventoryBackpack(player.getHeldItemMainhand()));
		}
		
		if (ID == GUIID_SATCHEL)
		{
			return new ContainerSatchel(player, player.inventory, new InventoryBackpack(player.getHeldItemMainhand()));
		}
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		if (ID == GUIID_BACKPACK)
		{
			return new GuiBackpack((ContainerBackpack) new ContainerBackpack(player, player.inventory, new InventoryBackpack(player.getHeldItemMainhand())));
		}
		
		if (ID == GUIID_SATCHEL)
		{
			return new GuiSatchel((ContainerSatchel) new ContainerSatchel(player, player.inventory, new InventoryBackpack(player.getHeldItemMainhand())));
		}
		return null;
	}
}
