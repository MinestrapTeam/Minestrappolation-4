package minestrapteam.mods.minestrappolation.api;
...
public class MRegistry
{
	...
	{
		SplitterRecipes.instance()
		               .addRecipe(new ItemStack(input), new ItemStack(stack), new ItemStack(stack2), experience);
	}
